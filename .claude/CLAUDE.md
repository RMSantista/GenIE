...
**GENIE** = **G**eneric **E**xtractor of **I**nformation **E**ngine
...
## Development Methodology — Agent Orchestration

Based on the **Orchestrator Pattern** (Ronie Uliana, Jan 2026).

> Full specification: **GENIE-ORCHESTRATION.md**
...
```
Phase 1: Understanding (lamp) → Phase 2: Planning (Orchestrator)
→ Phase 3: Implementation (wish) → Phase 4: Review (seal)
→ Phase 5: Validation (wish) → Phase 6: Finalization (Orchestrator)
```

### Interaction Levels

| Level      | Approval Points                       |
|------------|---------------------------------------|
| **Low**    | Only at end of complete development   |
| **Medium** | At each completed phase               |
| **High**   | At each completed step                |

### Correction Loops

- Review NOT ACCEPTABLE → Return to Implementation
- Tests failing → Return to Implementation
- Human rejects → Return per feedback

### Key Principle

The Orchestrator is a **Tech Lead who refuses to write code**: coordinates agents, defines goals, establishes success criteria, validates results.
